...
public class Tool {
	...
	public boolean syncFileFromSftp(Logger log, String host, String username, String password, String remote_path, String local_path) {
        try {
	...
	public <T> void mergeObj(T newObj, T oldObj) {
	...
	public String getTodayDateTimeInString(Logger log) {
		String result = "";
		try {
