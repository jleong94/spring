...
public class TaskExecutorConfig {
    ...
    Executor threadPoolTaskExecutor() {
        ...
        executor.setCorePoolSize(10); // Core threads always alive. Recommended to be based on CPU-bound or I/O-bound
                                      // nature of tasks.
        // Ask:
        ...
        executor.setQueueCapacity(500); // Number of tasks that can wait in the queue before new threads are spawned
                                        // beyond corePoolSize.
